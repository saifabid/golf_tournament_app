class UsersController < ApplicationController
  ...
  private
    # def user_params
    #   params.require(:user).permit(:user_id, :profile_pic, :prefix, :first_name, :middle_name, :last_name, :suffix, :home_adr1, :home_adr2, :home_city, :home_province, :home_code, :home_country, :bill_adr1, :bill_adr2, :bill_city, :bill_province, :bill_code, :bill_country, :gender, :birth, :mobile_phone, :is_home)
    # end
