...
class Tournament < ApplicationRecord
  ...
  validates_numericality_of :gold_sponsor_price, :silver_sponsor_price, :bronze_sponsor_price, :player_price,:spectator_price, :foursome_price, :numericality => {:greater_than =>0}
